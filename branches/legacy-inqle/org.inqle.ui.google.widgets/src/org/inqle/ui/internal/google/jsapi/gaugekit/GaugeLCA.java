 ...
 ******************************************************************************/
package org.inqle.ui.internal.google.jsapi.gaugekit;
...
public class GaugeLCA extends VisualizationWidgetLCA {
  ...
  public void renderInitialization( final Widget widget ) throws IOException {
    ...
    writer.newWidget( "org.inqle.ui.google.jsapi.Gauge", new Object[]{
      id
    } );
    writer.set( "appearance", "composite" );
    writer.set( "overflow", "hidden" );
    ControlLCAUtil.writeStyleFlags( ( Gauge )widget );
  }
}
