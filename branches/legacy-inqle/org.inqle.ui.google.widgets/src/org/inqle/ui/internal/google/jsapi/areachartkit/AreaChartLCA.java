 ...
 ******************************************************************************/
package org.inqle.ui.internal.google.jsapi.areachartkit;
...
public class AreaChartLCA extends VisualizationWidgetLCA {
  ...
  public void renderInitialization( final Widget widget ) throws IOException {
    ...
    writer.newWidget( "org.inqle.ui.google.jsapi.AreaChart", new Object[]{
      id
    } );
    writer.set( "appearance", "composite" );
    writer.set( "overflow", "hidden" );
    ControlLCAUtil.writeStyleFlags( ( AreaChart )widget );
  }
}
