 ...
 * in favor of ExternalDatasets of function EXTENSION_DATASET_PURPOSE_SCHEMAS
 */
	...
	public static void addDatafiles(QueryCriteria queryCriteria, String folderPath) {
		...
		for (File file: folder.listFiles()) {
			if (file.isDirectory()) {
				...
				queryCriteria.addModel(datafile.getId(), Persister.getModelFromFile(datafile.getFileUrl()));
			}
		}
	}
