 ...
 * Feb 20, 2008
 */
public class RdfTablePage extends BeanWizardPage {
	...
	private static final Logger log = Logger.getLogger(RdfTablePage.class);
...
//	private Table table;
	 ...
	 * @param titleImage
	 */
	public RdfTablePage(IBasicJenabean modelBean, String modelBeanValueId, Class<?> modelListClass, String title, ImageDescriptor titleImage) {
