 ...
 */
@Deprecated
public abstract class SparqlView_orig extends ViewPart implements SelectionListener, Listener {

	private static final Logger log = Logger.getLogger(SparqlView_orig.class);
