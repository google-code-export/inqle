 ...
 * @since 1.1.0
 */
public class TypicalsecurityMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = TypicalsecurityMetadata.class.getName();
    ...
    public TypicalsecurityMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
