...
import org.inqle.web.ParticipantController;
...
privileged aspect ParticipantController_Roo_Controller {
    ...
    void ParticipantController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("participant_created_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("participant_updated_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
