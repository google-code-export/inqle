...
@Namespace(RDF.INQLE)
public class orig_LearningCycle extends UniqueJenabean implements ILearningCycle {
	...
	private static Logger log = Logger.getLogger(orig_LearningCycle.class);
...
//		this.sampler = sampler.createClone();
	...
	public orig_LearningCycle createClone() {
		orig_LearningCycle newObj = new orig_LearningCycle();
		//newObj.setPersister(persister);
		newObj.clone(this);
		return newObj;
	}

	public orig_LearningCycle createReplica() {
		orig_LearningCycle newObj = new orig_LearningCycle();
		//newObj.setPersister(persister);
	...
	public void clone(orig_LearningCycle objectToBeCloned) {
	...
	public void replicate(orig_LearningCycle objectToClone) {
		clone(objectToClone);
