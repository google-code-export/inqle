...
import com.beyobe.web.ConceptController;
...
privileged aspect ConceptController_Roo_Controller {
    ...
    public String ConceptController.show(@PathVariable("id") String id, Model uiModel) {
    ...
    public String ConceptController.updateForm(@PathVariable("id") String id, Model uiModel) {
        populateEditForm(uiModel, Concept.findConcept(id));
        return "concepts/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ConceptController.delete(@PathVariable("id") String id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
