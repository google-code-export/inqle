...
//	}
	...
	public Arc decideLabelArc(Collection<String> modelsToUse, Resource subjectClass) {
		Collection<Arc> randomArcs = ArcLister.getRandomFilteredValuedArcs(SamplingInfo.SAMPLER_DB, modelsToUse, subjectClass.toString(), MAX_PROPERTY_ARC_DEPTH, 1, null);
	...
	public Collection<Arc> decideLearnableArcs(Collection<String> modelsToUse, Resource subjectClass, int numberToSelect, Collection<Arc> arcsToExclude) {
		...
		Collection<Arc> randomArcs = ArcLister.getRandomFilteredValuedArcs(SamplingInfo.SAMPLER_DB, modelsToUse, subjectClass.toString(), MAX_PROPERTY_ARC_DEPTH, numberToSelect, arcsToExclude);
...
//		return decidedArcs;
	...
	protected URI decideSubjectClass(Collection<String> modelsToUse) {
		...
		Collection<String> randomSubjectClasses = SubjectClassLister.getRandomUncommonSubjectClasses(SamplingInfo.SAMPLER_DB, modelsToUse, 1, null);
