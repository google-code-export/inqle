 ...
 ******************************************************************************/
package org.inqle.ui.internal.google.jsapi.geomapkit;
...
public class GeomapLCA extends VisualizationWidgetLCA {
  ...
  public void renderInitialization( final Widget widget ) throws IOException {
    ...
    writer.newWidget( "org.inqle.ui.google.jsapi.Geomap", new Object[]{
      id
    } );
    writer.set( "appearance", "composite" );
    writer.set( "overflow", "hidden" );
    ControlLCAUtil.writeStyleFlags( ( Geomap )widget );
  }
}
