 ...
 ******************************************************************************/
package org.inqle.ui.internal.google.jsapi.intensitymapkit;
...
public class IntensityMapLCA extends VisualizationWidgetLCA {
  ...
  public void renderInitialization( final Widget widget ) throws IOException {
    ...
    writer.newWidget( "org.inqle.ui.google.jsapi.IntensityMap", new Object[]{
      id
    } );
    writer.set( "appearance", "composite" );
    writer.set( "overflow", "hidden" );
    ControlLCAUtil.writeStyleFlags( ( IntensityMap )widget );
  }
}
