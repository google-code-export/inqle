 ...
 */
public class RemoteDrupalAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    private final Logger log = Logger.getLogger(RemoteDrupalAuthenticationProvider.class);
