...
import org.inqle.web.AccountController;
...
privileged aspect AccountController_Roo_Controller {
    ...
    void AccountController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("account_created_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("account_updated_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    
    void AccountController.populateEditForm(Model uiModel, Account account) {
        uiModel.addAttribute("account", account);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("privileges", Arrays.asList(Privilege.values()));
    }
