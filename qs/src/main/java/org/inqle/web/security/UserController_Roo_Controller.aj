...
import org.inqle.web.security.UserController;
...
privileged aspect UserController_Roo_Controller {
    ...
    void UserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("principal_created_date_format", DateTimeFormat.patternForStyle("FF", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("principal_updated_date_format", DateTimeFormat.patternForStyle("FF", LocaleContextHolder.getLocale()));
    }
