...
import com.beyobe.client.views.CarouselTagdayView;
...
public class CarouselTagdayActivity extends AbstractActivity implements CarouselTagdayView.Presenter {
    private Place defaultPlace;

    private static Logger log = Logger.getLogger("TagdayActivity");
    
    public CarouselTagdayActivity(Place defaultPlace) {
